...
# --- After All Questions ---
    ...
    # Step 2: Structured OpenAI Response
    if st.button("🧬 Generate Structured Analysis (via OpenAI)"):
        prompt = f"""
...
"""
        with st.spinner("Calling OpenAI for structured analysis..."):
        ...
        try:
            ...
            st.success("✅ Structured response from OpenAI:")
            st.json(structured_data)
        except Exception as e:
            st.error("❌ Failed to parse OpenAI structured response.")
